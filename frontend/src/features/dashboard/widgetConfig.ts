...
export const WIDGET_CONFIGS: WidgetConfig[] = [
  ...
  { id: 'stat_unread_alerts', title: 'Unread Alerts', category: 'stats', defaultVisible: true },
  ...
  // Security Widgets
  { id: 'widget_top_malicious_ips', title: 'Top Malicious IPs', category: 'widgets', defaultVisible: true },
  { id: 'widget_recent_alerts', title: 'Recent Alerts', category: 'widgets', defaultVisible: true },
  { id: 'widget_threat_map', title: 'Threat Map', category: 'widgets', defaultVisible: true },
];
