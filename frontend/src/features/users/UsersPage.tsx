...
const UsersPage = () => {
  const { user: currentUser } = useAuth();  // Get current user for self-deletion protection
                  ...
                  <tr key={user.id} className="hover:bg-slate-900/40 dark:hover:bg-slate-900/40 light:hover:bg-slate-50 transition">
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className={`flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium transition disabled:opacity-50 disabled:cursor-not-allowed ${user.is_active
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="rounded-lg border border-red-800 dark:border-red-800 light:border-red-300 bg-red-950/20 dark:bg-red-950/20 light:bg-red-50 p-2 text-red-400 dark:text-red-400 light:text-red-700 transition hover:bg-red-950/40 dark:hover:bg-red-950/40 light:hover:bg-red-100 disabled:opacity-50 disabled:cursor-not-allowed"
                          title={currentUser?.id === user.id ? "You cannot delete your own account" : "Permanently delete user"}
                        >
