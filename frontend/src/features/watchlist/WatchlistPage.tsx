...
import type { Watchlist, WatchlistCreate, WatchlistListResponse, WatchlistAsset, AssetCheckHistoryListResponse, IOCType } from "@/features/watchlist/types";
            ...
            <div className="space-y-2">
              {watchlists?.watchlists.map((watchlist) => (
                <div
                  ...
                  className={`cursor-pointer rounded-lg border p-3 transition ${selectedWatchlist === watchlist.id
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {canManageWatchlists ? (
                      <button
                        ...
                        className={`rounded-lg p-1.5 transition ${watchlist.is_active
          ...
          <div className="flex gap-2">
            {canManage && (
              <button
                ...
                className={`flex items-center gap-2 rounded-lg border px-3 py-2 text-sm transition ${watchlist.is_active
          ...
          <div className="rounded-lg border border-slate-800 dark:border-slate-800 light:border-slate-200 bg-slate-950/60 dark:bg-slate-950/60 light:bg-slate-50 p-4">
            ...
            <div className="grid gap-3 md:grid-cols-5">
              <select
                ...
                onChange={(e) => setNewAsset({ ...newAsset, ioc_type: e.target.value as IOCType })}
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {data.items.map((history) => (
                <div
                  key={history.id}
                  className={`rounded-lg border p-4 ${history.alert_triggered
